...
SRC1 = $(addprefix ../, part1/checker.c part1/does_solve.c part1/push_elem.c part1/rot_elem.c part1/check_valid.c \
...
SRC2 = $(addprefix ../, part1/push_elem.c part1/rot_elem.c part2/get_actions.c \
...
SRC3 = $(addprefix ../, generator/create_rand.c libft/ft_putnbr_fd.c libft/ft_putnbr.c libft/ft_putchar_fd.c \
libft/ft_atoi.c)
...
1:	
	@(cd objects1; gcc -Wall -Wextra -Werror -c $(SRC1) $(HEADERS))
	@gcc -Wall -Wextra -Werror $(OBJ1) -o $(NAME1)

2:
	@(cd objects2; gcc -Wall -Wextra -Werror -c $(SRC2) $(HEADERS))
	@gcc -Wall -Wextra -Werror $(OBJ2) -o $(NAME2)

3:
	@(cd objects3; gcc -Wall -Wextra -Werror -c $(SRC3) $(HEADERS))
	@gcc -Wall -Wextra -Werror  $(OBJ3) -o $(NAME3)
